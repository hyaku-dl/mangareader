...
<p align="center">
    <a href="https://app.codacy.com/gh/hyaku-dl/mangareader/dashboard">
        <img alt="Codacy Badge" src="https://img.shields.io/codacy/grade/385ceb2d55424256a93f9ad6f8007f91?style=flat-square">
    </a>
    <a href="https://wakatime.com/projects/urasunday/dhtjprazfe">
        <img alt="Wakatime Badge" src="https://wakatime.com/badge/github/hyaku-dl/mangareader.svg?style=flat-square">
    </a>
    <a href="https://github.com/hyaku-dl/mangareader/releases">
        <img alt="GitHub release (latest by date including pre-releases)" src="https://img.shields.io/github/v/release/hyaku-dl/mangareader?include_prereleases&style=flat-square">
    </a>
    <a href="https://github.com/hyaku-dl/mangareader/releases">
        <img alt="GitHub Workflow Status" src="https://img.shields.io/github/workflow/status/hyaku-dl/mangareader/Build?label=build&style=flat-square">
    </a>
</p>
<p align="center">
...
Github: [github.com/hyaku-dl/mangareader](https://github.com/hyaku-dl/mangareader)

Website: [mrt.hyaku.download](https://mrt.hyaku.download)
...
Interested in commissioning projects? Inquire through Discord(<a target="_blank" href="https://discord.com/users/848092597822160907">malice#0118</a>) or through e-mail(<a target="_blank" href="mailto:whinyaan@protonmail.com">whinyaan@protonmail.com</a>). Price starts at 15 USD.
...
This app is currently has reached the rc phase! If you can spare some time and effort, please consider testing the app and reporting the bugs you find either through [raising a new Github issue](https://github.com/hyaku-dl/mangareader/issues/new) or through [the Discord Support Server](https://discord.com/invite/JbAtUxGcJZ). Any suggestions are also welcome! Thank you to everyone who supported this app from the very beginning.
...
Follow [this link](https://github.com/hyaku-dl/mangareader/releases), and download the appropriate executable for your machine.
...
```ps1
git clone https://github.com/hyaku-dl/mangareader . &&
